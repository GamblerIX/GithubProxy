// ==UserScript==
// @name         GitHub 镜像站汉化脚本
// @description  汉化 GitHub 镜像站的部分菜单及内容。
...
// @require      https://raw.githubusercontent.com/maboloshi/github-chinese/gh-pages/locals.js?v1.9.3-2025-09-05
...
(function (window, document, undefined) {
    ...
    const CONFIG = {
        ...
        // 需要特殊处理的站点类型
        SPECIAL_SITES: ['gist1', 'status', 'skills', 'education', 'gist2'],
        // 简介 css 筛选器规则
        DESC_SELECTORS: {
            repository: ".f4.my-3",
